...
//    std::make_shared<MutliTextureMat>("..\\textures\\stone_diff.png","..\\textures\\stone_normal.png");
    ...
    std::shared_ptr<Geometry>
            floor = std::make_shared<Rectangle>(Vec3f(0, 10, 0), Vec2f(5, 20), Vec3f(0, 0, 1), Vec3f(1, 0, 0));
    std::shared_ptr<Geometry>
            floor2 = std::make_shared<Rectangle>(Vec3f(0, 20, 0), Vec2f(5, 20), Vec3f(0, 0, 1), Vec3f(1, 0, 0));
    std::shared_ptr<Geometry>
